                    ...
                    <div className="services-details-items">
                        <div className="row">
                            <div className="col-xl-8 col-lg-7 order-lg-last pl-50 pl-md-15 pl-xs-15">
                                <div className="thumb">
                                    <Image src={`/assets/img/banner/7.jpg`} alt="Thumb" width={2000} height={1045} />
                                </div>
                                <h2>{title}</h2>
                                <p>
                                        ...
                                        <div className="col-lg-5 col-md-6">
                                            <div className="content">
                                                ...
                                                <ul className="feature-list-item">
                                                    ...
                                                    <li>24/7 All time Supporting</li>
                            ...
                            <div className="col-xl-4 col-lg-5 mt-md-120 mt-xs-50 services-sidebar">
                                ...
                                <div className="single-widget widget-brochure">
                                    ...
                                    <ul>
                                        <li><Link href="#" scroll={false}><i className="fas fa-file-pdf" /> Download Brochure </Link></li>
                                        <li><Link href="#" scroll={false}><i className="fas fa-file-pdf" /> Company Details </Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
