                            ...
                            <div className="blog-content wow fadeInUp col-lg-10 offset-lg-1 col-md-12">
                                <div className="blog-style-two item">
                                    <div className="blog-item-box">
                                        <div className="thumb">
                                            <Image src={`/assets/img/blog/${thumbFull}`} alt="Thumb" width={1075} height={545} />
                                        </div>
                                        <div className="info">
                                            <div className="meta">
                                                <ul>
                                                    <li>
                                                        <Link href="#"><i className="fas fa-calendar-alt" /> {date}</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="#"><i className="fas fa-user-circle" /> {author}</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                            <p>
                                ...
                                <div className="post-author">
                                    <div className="thumb">
                                        <Image src="/assets/img/teams/1.jpg" alt="Thumb" width={150} height={150} />
                                    </div>
                                    <div className="info">
