export const siteContent = {
    ...
    home: {
        ...
        partners: [
            ...
            { name: "Dell", logo: "/assets/img/partners/dell.png" },
            { name: "Cisco", logo: "/assets/img/partners/cisco.png", status: "Select Partner" },
            { name: "HP", logo: "/assets/img/partners/hp.png", status: "Business Partner" }
        ]
    },
    about: {
        title: "About Us",
